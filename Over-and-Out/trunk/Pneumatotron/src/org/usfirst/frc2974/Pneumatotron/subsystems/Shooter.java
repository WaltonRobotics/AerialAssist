...
import org.usfirst.frc2974.Pneumatotron.commands.*;
...
public class Shooter extends Subsystem {
    ...
    /**
     * Charge method switches the main two pistons on so that the catapult
     * builds potential energy This method should always be called before the
     * release() method
     */
    public void charge() {
        shaftA.set(true);
    ...
    /**
     * Relax method sets all the pistons to their default state which allows for
     * the ball to be placed in the catapult
     */
    ...
    /**
     * Release method releases the latch on the catapult and allows the
     * mechanism to fire
     */
