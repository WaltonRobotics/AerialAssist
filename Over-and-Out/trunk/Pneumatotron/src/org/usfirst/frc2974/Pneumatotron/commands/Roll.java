...
public class Roll extends Command {
	...
	/**
	 * Two basic threads: lifting thread and roller thread if the top button is pressed, the intake raises, and if the
	 * bottom button is pressed, the intake lowers
	 *
	 * The roller is toggled on a rising edge. If the trigger is pressed, it is enabled. It cannot be disabled now until
	 * the trigger is released. Once on, if the trigger is pressed, it will disable. It cannot be enabled now until the
	 * trigger is released.
	 */
